...
exports.forgot = exports.logout = exports.login = void 0;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            //res.data here is the json data we sent to API
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Token sent!");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8000/api/v1users/updateMyPassword' : 'http://localhost:8000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            //res.data here is the json data we sent to API
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Product created!");
              window.setTimeout(function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            console.log(data); //res.data here is the json data we sent to API

            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "You are a member now!");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:8000/api/v1/suits/".concat(id),
              data: data
            });
...
var stripe = Stripe('pk_test_Ha2Vi3tjbinYc7ZkuqNYD49Z00BP2XlKam');

var orderProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(suitId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://localhost:8000/api/v1/orders/checkout-session/".concat(suitId)
            });
...
var createProduct = document.querySelector(".form-create-products");
var updateProduct = document.querySelector(".form-update-products");
var SignUp = document.querySelector(".form-signup");
var orderBtn = document.getElementById("buy-now"); //DELEGATION
...
if (createProduct) createProduct.addEventListener("submit", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            formCreate.append("description", document.getElementById("description").value);
            formCreate.append("imageCover", document.getElementById("imageCover").files[0]);
            ...
            _context2.next = 14;
            return (0, _manage.create)(formCreate);
...
if (updateProduct) updateProduct.addEventListener("submit", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            formUpdate.append("imageCover", document.getElementById("up-imageCover").files[0]);
            ...
            _context3.next = 10;
            return (0, _update.update)(formUpdate);
...
if (SignUp) SignUp.addEventListener("submit", /*#__PURE__*/function () {
